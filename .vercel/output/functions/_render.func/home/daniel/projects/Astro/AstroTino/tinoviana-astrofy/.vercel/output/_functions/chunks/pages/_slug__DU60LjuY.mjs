/* empty css                           */
import { e as createAstro, f as createComponent, r as renderTemplate, j as renderComponent, m as maybeRenderHead, h as addAttribute, l as renderSlot } from '../astro_D2Aa9jdi.mjs';
import 'kleur/colors';
import { g as getCollection, c as createSlug } from './__XoI_UWAZ.mjs';
import { $ as $$Image, a as $$BaseLayout } from './404_QX4IlX_o.mjs';
...
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/layouts/PostLayout.astro", void 0);
...
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/artigos/[slug].astro", void 0);

const $$file$2 = "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/artigos/[slug].astro";
...
const $$slug$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { Content } = await entry.render();
  return renderTemplate`${renderComponent($$result, "PostLayout", $$PostLayout, { "title": post.title, "description": post.description, "pubDate": post.pubDate, "heroImage": post.heroImage, "updatedDate": post.updatedDate, "badge": post.badge, "tags": post.tags }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/servicos/[slug].astro", void 0);

const $$file$1 = "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/servicos/[slug].astro";
...
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/layouts/StoreItemLayout.astro", void 0);
...
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/store/[slug].astro", void 0);

const $$file = "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/store/[slug].astro";
