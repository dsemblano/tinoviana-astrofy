...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_D_5fbzzE.mjs'
    ).then(n => n.k).catch((e) => {
...
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/node_modules/.pnpm/astro@4.7.0_typescript@5.4.5/node_modules/astro/components/Picture.astro", void 0);
...
}, "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/404.astro", void 0);

const $$file = "/home/daniel/projects/Astro/AstroTino/tinoviana-astrofy/src/pages/404.astro";
const $$url = "/404";
...
export { $$BaseLayout as $, SITE_TITLE as S, _404 as _, $$Image as a, SITE_DESCRIPTION as b, getConfiguredImageService as g, imageConfig as i };
